...
class Audio(Enum):
    ...
    Available audio language options (s.to only):
        - GERMAN:  German dub
        - ENGLISH: English dub
        - JAPANESE: Japanese dub (for subtitled series)
    """
...
class SerienstreamEpisode:
    ...
    Attributes (Example):
        ...
        series:                 <mediaforge.models.s_to.series.SerienstreamSeries object at 0x10ad96cf0>
        season:                 <mediaforge.models.s_to.season.SerienstreamSeason object at 0x10ad96e40>
    ...
    def provider_url(self):
        if self.__provider_url is None:
            ...
            try:
                ...
                from mediaforge.playwright.captcha import solve_sto_modal
            ...
            if urlparse(resp.url).netloc != urlparse(self.redirect_url).netloc:
                ...
                lang = self._normalize_language(self.selected_language)
                if lang == (Audio.ENGLISH, Subtitles.GERMAN):
                    language_label = "Deutsche Untertitel"
                elif lang == (Audio.ENGLISH, Subtitles.NONE):
                    language_label = "Englisch"
                else:
