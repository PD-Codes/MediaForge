    ...
    "system_info": {
        ...
        "explain": {
            "de": (
                ...
                "-Variante, Oberflächensprache, das angewendete Design-Paket (Name des Themes bzw. "
                "„Standard“), Prozessorarchitektur, CPU-Modell und Kernanzahl, "
            ...
            "en": (
                ...
                "language, the applied theme pack (its name, or \"default\"), processor "
                "architecture, CPU model and core count, total memory size, "
