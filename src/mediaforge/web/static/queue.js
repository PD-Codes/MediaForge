...
const _QHUB_CAUSES = {
  ...
  security_blocked: [["Von MediaForge blockiert", "Blocked by MediaForge"], ["Die Ziel-Adresse steht nicht auf der erlaubten Liste — der Schutz gegen Anfragen ins eigene Netz hat gegriffen. Der Host muss unter Netzwerk & Zugriff freigegeben werden.", "The target address is not on the allow list — the guard against requests into your own network stepped in. Allow the host under Network & Access."]],
  ...
  hoster_maintenance: [["Hoster im Wartungsmodus", "Hoster in maintenance"], ["Der Hoster ist absichtlich offline. Später erneut versuchen — ein anderer Hoster hilft hier meist schneller.", "The hoster is deliberately offline. Retry later — another hoster is usually the faster way."]],
  not_implemented:  [["Hoster nicht unterstützt", "Hoster not supported"], ["Für diesen Hoster gibt es noch keinen Extractor. Erneut versuchen hilft nicht; in den Einstellungen die Hoster-Reihenfolge anpassen.", "There is no extractor for this hoster yet. Retrying will not help; change the hoster order in the settings."]],
  ...
  ffmpeg_failed:    [["ffmpeg ist ausgestiegen", "ffmpeg failed"], ["ffmpeg lief, brach aber ab — meist eine unvollständige Quelldatei oder ein Encoder, den die Hardware nicht kann. Der Originaltext unten nennt den Grund.", "ffmpeg ran but bailed out — usually a truncated source file or an encoder the hardware cannot do. The original text below names the reason."]],
