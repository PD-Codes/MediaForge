...
- **Catalogue** — the complete A–Z list AniWorld and SerienStream publish (2.4k and 10.8k titles), with instant filtering, an A–Z jump rail, filters for what you already have, queued or auto-sync, A–Z/Z–A sorting, multi-select and a details view per title; hand the whole selection to the download queue or to Auto-Sync in one go
